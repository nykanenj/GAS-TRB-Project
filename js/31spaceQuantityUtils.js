const insertColumnAndFormulas = (sheetObj, newColumnName = 'temp') => {
  ...
  sheetObj.sheet.getRange(sheetObj.startRow + 1, sheetObj.col[enums.KALUSTESUUNNITELMA.HEADINGS.Maara_tila_1]).getA1Notation() + ':' +
  ...
  if (sheetObj.nRows > 2) firstFormulaCell.copyTo(sheetObj.sheet.getRange(sheetObj.startRow + 2, maaraYhtCol, sheetObj.nRows - 2)); // Copy Down formula. -2 to omit headingRow and first formula cell
