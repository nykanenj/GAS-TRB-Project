...
const enums = {
  ...
  NAMEDRANGES: {
    ...
    KALUSTESUUNNITELMA: {
      spaceQuantityFirstColumnIndex:
        "KALUSTESUUNNITELMA.spaceQuantityFirstColumnIndex", // enums.NAMEDRANGES.spaceQuantytyFirstColumnIndex
      spaceQuantityLastColumnIndex:
        "KALUSTESUUNNITELMA.spaceQuantityLastColumnIndex", // enums.NAMEDRANGES.spaceQuantityLastColumnIndex
    },
    ASENNUSLISTA: {
      spaceQuantityFirstColumnIndex:
        "ASENNUSLISTA.spaceQuantityFirstColumnIndex", // enums.NAMEDRANGES.spaceQuantytyFirstColumnIndex
  ...
  KALUSTESUUNNITELMA: {
    ...
    HEADINGS: {
      ...
      Vahvistettu_toimituspaiva_tehtaalta:
        "Vahvistettu toimituspäivä tehtaalta", // enums.KALUSTESUUNNITELMA.HEADINGS.Vahvistettu_toimituspaiva_tehtaalta
  ...
  ASENNUSLISTA: {
    ...
    HEADINGS: {
      ...
      Vahvistettu_toimituspaiva_tehtaalta:
        "Vahvistettu toimituspäivä tehtaalta", // enums.ASENNUSLISTA.HEADINGS.Vahvistettu toimituspäivä tehtaalta
